...
int main()
{
    ...
    rb_remove(&rb, &num[0], ft_nbrcmp);
    ft_putstr("\nremove> "); ft_putnbr(num[0]); ft_putstr("\n");
    rb_apply_by_level(rb, rb_print_node);

    rb_remove(&rb, &num[5], ft_nbrcmp);
    ft_putstr("\nremove> "); ft_putnbr(num[5]); ft_putstr("\n");
    rb_apply_by_level(rb, rb_print_node);

    rb_remove(&rb, &num[3], ft_nbrcmp);
    ft_putstr("\nremove> "); ft_putnbr(num[3]); ft_putstr("\n");
    rb_apply_by_level(rb, rb_print_node);
